...
const int         mygllib::Material::EMERALD =  0;
const int            mygllib::Material::JADE =  1;
const int        mygllib::Material::OBSIDIAN =  2;
const int           mygllib::Material::PEARL =  3;
const int            mygllib::Material::RUBY =  4;
const int       mygllib::Material::TURQUOISE =  5;
const int           mygllib::Material::BRASS =  6;
const int          mygllib::Material::BRONZE =  7;
const int          mygllib::Material::CHROME =  8;
const int          mygllib::Material::COPPER =  9;
const int            mygllib::Material::GOLD = 10;
const int          mygllib::Material::SILVER = 11;
const int   mygllib::Material::BLACK_PLASTIC = 12;
const int    mygllib::Material::CYAN_PLASTIC = 13;
const int   mygllib::Material::GREEN_PLASTIC = 14;
const int     mygllib::Material::RED_PLASTIC = 15;
const int   mygllib::Material::WHITE_PLASTIC = 16;
const int  mygllib::Material::YELLOW_PLASTIC = 17;
const int    mygllib::Material::BLACK_RUBBER = 18;
const int     mygllib::Material::CYAN_RUBBER = 19;
const int    mygllib::Material::GREEN_RUBBER = 20;
const int      mygllib::Material::RED_RUBBER = 21;
const int    mygllib::Material::WHITE_RUBBER = 22;
const int   mygllib::Material::YELLOW_RUBBER = 23;
float mygllib::Material::material[] = {
